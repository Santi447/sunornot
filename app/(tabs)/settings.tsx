...
import {
  ...
  useSettings,
  WindUnit,
} from "../../components/settings_screen/settings_context";
...
const IconThermo = () => (
  <Svg width={15} height={15} viewBox="0 0 24 24" fill="none">
    <Path
      d="M14 14.76V3.5a2.5 2.5 0 00-5 0v11.26A4.5 4.5 0 1014 14.76z"
      stroke="#f87171"
      strokeWidth={2}
    />
  </Svg>
          ...
          >
            ...
            <SettingsSection label="Notifications">
              <SettingsRow
                ...
                right={
                  <Toggle value={dailyForecast} onChange={setDailyForecast} />
                }
              />
              <SettingsRow
                icon={<IconAlert />}
                ...
                right={
                  <Toggle value={severeAlerts} onChange={setSevereAlerts} />
                }
                last
              />
            </SettingsSection>
